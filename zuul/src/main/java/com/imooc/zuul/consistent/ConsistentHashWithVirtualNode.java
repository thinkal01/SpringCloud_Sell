...
public class ConsistentHashWithVirtualNode {
    ...
    public ConsistentHashWithVirtualNode(List<String> serverList, int virtualNodeNum) {
    ...
    public ConsistentHashWithVirtualNode(List<String> serverList) {
        // 默认为服务实例数,经测试分发请求数较为平均
        this(serverList, serverList.size());
    }
    ...
    public String getServer(String key) {
        if (CollectionUtils.isEmpty(HASH_CIRCLE)) {
            return null;
        }
